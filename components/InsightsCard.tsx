      ...
      <div className="min-h-[200px]">
        {loading && (
          <div className="flex flex-col items-center justify-center h-[200px]">
            ...
            <p className="text-sm text-gray-600">Analyzing your energy usage...</p>
          </div>
        )}
        ...
        {error && !loading && (
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-red-800">Error generating insights</h4>
        ...
        {!insights && !loading && !error && (
          <div className="flex flex-col items-center justify-center h-[200px] text-center">
            ...
            <p className="text-sm text-gray-600 mb-2">No insights generated yet</p>
